import TableMutation from '../mutations/tableMutation.js'
import fs from 'fs'
import pkg from 'pg';
const {Client} = pkg;
import XLSX from 'xlsx'
import {USER, PASSWORD, HOST, DB} from '../config/db.config.js'

const FILE_PATHNAME = process.env.FILE_PATHNAME

const conn = `postgres://${USER}:${PASSWORD}@${HOST}/${DB}` // connection config
